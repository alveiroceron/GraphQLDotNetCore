...
namespace GraphQLDotNetCore
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddScoped<OwnerSchema>();
			services.AddScoped<AccountSchema>();

            services.AddGraphQL()
                .AddSystemTextJson()
                .AddGraphTypes(typeof(OwnerSchema), ServiceLifetime.Scoped)
                .AddDataLoader();
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			//app.UseGraphQL<AccountSchema>("/api/account");
			app.UseGraphQL<OwnerSchema>("/api/owner");
